...
public class Movie implements Parcelable {
    ...
    public Movie(long id, String title, String posterPath, double voteAverage, String overview, String releaseDate) {
        this.id = id;
    ...
    public String getPosterPath() {
        return posterPath != null && posterPath.contains("http") ? posterPath : POSTER_BASE_URL + posterPath;
    }
