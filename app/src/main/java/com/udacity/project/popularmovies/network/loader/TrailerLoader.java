...
/**
 * Loader that returns a list of trailers for the specified movie by the movieId param.
 */
public class TrailerLoader extends AsyncTaskLoader<ArrayList<Trailer>> {

    private final long movieId;

    public TrailerLoader(@NonNull Context context, long movieId) {
        super(context);
    ...
    public ArrayList<Trailer> loadInBackground() {
        try {
            ...
            response = movieService.fetchTrailers(movieId).execute();
